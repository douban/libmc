...
DataBlock::DataBlock(const DataBlock& other) {
  if (other.m_data != NULL) {
    log_err(
        "copy constructor of DataBlock should never be "
        "called after initialization.");
    return;
  }
  assert(other.m_data == NULL && other.m_capacity == 0 && other.m_size == 0 &&
         other.m_nBytesRef == 0);
...
size_t DataBlock::minCapacity() { return s_minCapacity; }
...
size_t DataBlock::capacity() { return m_capacity; }
...
size_t DataBlock::getWriteLeft() { return m_capacity - m_size; }
...
bool is_not_digit(int c) { return !('0' <= c && c <= '9'); }
...
bool DataBlock::reusable() { return m_nBytesRef == 0; }

size_t DataBlock::nBytesRef() { return m_nBytesRef; }
