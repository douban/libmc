...
inline const bool Connection::alive() { return m_alive; }

inline const char* Connection::name() { return m_name; }

inline const char* Connection::host() { return m_host; }

inline const uint32_t Connection::port() { return m_port; }

inline const bool Connection::hasAlias() { return m_hasAlias; }

inline const int Connection::getRetryTimeout() { return m_retryTimeout; }
